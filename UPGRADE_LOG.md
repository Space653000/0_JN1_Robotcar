...
|------|------|------|------|------|------|------|----------|------|
| 2026-08-27 | 17:44:00 | M3-6b 完成 | 2.0.0 | 語音迴圈延遲分析+ASR GPU 加速 ✅ | ✅ 分析完成 | qwen2.5:3b | - | ✅ 四段延遲拆解；✅ 瓶颈確認：TTS 占 77–90%；✅ ASR GPU 加速實裝（device=cuda, compute=float16）；✅ Brain 序列化鎖定（M3-5b）；✅ 總延遲 3.8–19.7s（TTS 為主因，Kokoro 高質量但速度慢）；✅ 後續優化建議：換 TTS 引擎或流式播放 |
